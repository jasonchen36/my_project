// app/routes.js
module.exports = function(app, passport,l_data,interl_data,qubl_data,User,Query,db) {
...
Dmovie=function (callback)  {db.open(function(err, db) {
    if (!err) {
      console.log('got dmovies')
      callback(db.collection('dmovies'))
    } else {
      onErr(err, callback);
    }
  }); // end db.open
...
getdata1(fquery,function(data){


  console.log("gotdata finished")
