...
//fquery.push({women_18_24_ratio:{$gte:Number(90),$lte:Number(100)}})
//dquery.push({women_18_24_ratio:{$gte:Number(90),$lte:Number(100)}})

//console.log(gdata.fquery)
...
getdata1 = function(fquery, callback) {  
  db.open(function(err, db) {
    if (!err) {
      db.collection('loca_dmovies', function(err, collection) {
        if (!err) {
...
/*
   ...
   ////kfr_min                                     return d.percentage >= Number(filters.kfr_min)&& d.percentage<=Number(filters.kfr_max)})
