...
(function($)
{
	...
	var p = TextExtAutocomplete.prototype,
		...
		DEFAULT_OPTS = {
			...
			html : {
				dropdown   : '<div class="text-dropdown"><div class="text-list" style="color:black"/></div>',
				suggestion : '<div class="text-suggestion"><span class="text-label" style="color:black"/></div>'
			}
		}
		;
