var _0x931b = ["onmessage", "/../pred", "data", "postMessage", "POST", "GET", "", "=", "push", "&", "join", "open", "Content-type", "application/x-www-form-urlencoded", "setRequestHeader", "onreadystatechange", "readyState", "status", "responseText", "send"];
